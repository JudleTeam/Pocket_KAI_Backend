...
from core.services.providers import (
    get_discipline_service, get_lesson_service, get_schedule_service, get_group_service, get_service_token_service,
    get_teacher_service, get_department_service,
)
...
ServiceTokenServiceDep = Annotated[ServiceTokenServiceBase, Depends(get_service_token_service)]
