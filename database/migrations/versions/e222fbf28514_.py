...
Revision ID: e222fbf28514
Revises: 
Create Date: 2024-04-01 11:05:39.939116
...
def upgrade() -> None:
    ...
    op.create_table('pocket_kai_user',
    ...
    op.create_table('kai_user',
                    sa.Column('kai_id', sa.BigInteger(), nullable=True),
                    sa.Column('position', sa.Integer(), nullable=True),
                    sa.Column('login', sa.String(), nullable=True),
                    sa.Column('password', sqlalchemy_utils.types.encrypted.encrypted_type.StringEncryptedType(),
                              nullable=True),
    ...
    op.create_table('group_lesson',
                    ...
                    sa.Column('parity_of_week', sa.String(), nullable=True),
                    sa.Column('int_parity_of_week', sa.Integer(), nullable=False),
                    sa.Column('auditory_number', sa.String(), nullable=True),
